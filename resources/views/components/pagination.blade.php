...
<div class="flex justify-center items-center gap-1.5 mt-12 mb-6">
    ...
    @else
        <span class="px-4 py-2 bg-white/5 rounded-xl text-sm text-slate-400 border border-white/5 cursor-not-allowed">← Prev</span>
    @endif
    ...
    @else
        <span class="px-4 py-2 bg-white/5 rounded-xl text-sm text-slate-400 border border-white/5 cursor-not-allowed">Next →</span>
    @endif
</div>
@endif
