...
<body class="bg-[#020617] text-slate-200 min-h-screen antialiased">
    ...
    {{-- HEADER BAR --}}
    <header class="fixed top-0 left-0 right-0 z-50 bg-slate-950/60 backdrop-blur-xl border-b border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14">
                ...
                <form action="{{ url(route('search', [], false)) }}" method="GET" class="relative flex-1 max-w-md mx-4">
                    <input type="text" name="q" value="{{ request('q') }}" placeholder="Search movies..."
                        class="w-full bg-white/5 text-white placeholder-slate-400 rounded-xl px-4 py-2 pl-10 focus:outline-none focus:ring-1 focus:ring-accent/40 focus:bg-white/10 text-sm border border-white/5 transition-all">
                    <svg class="absolute left-3 top-2.5 w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                    </svg>
                </form>
                <button id="mobile-menu-btn" aria-label="Open menu" class="lg:hidden p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/5 transition-all">
    ...
    {{-- NAVBAR --}}
    <nav class="fixed top-14 left-0 right-0 z-40 bg-slate-950/60 backdrop-blur-xl border-b border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('watchlist') }}" class="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-white/5 transition-all" title="Watchlist">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"/></svg>
                    </a>
                    <a href="{{ route('calendar') }}" class="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-white/5 transition-all" title="Calendar">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                    </a>
                </div>
            </div>
        </div>
        <div id="mobile-menu" class="hidden lg:hidden bg-slate-950/95 backdrop-blur-xl border-t border-white/5">
    ...
    <footer class="mt-20 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="border-t border-white/5 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                <p class="text-slate-400 text-xs">&copy; {{ date('Y') }} MovieFlix</p>
                <p class="text-slate-400 text-xs">Data by <a href="https://www.themoviedb.org/" target="_blank" class="text-slate-400 hover:text-white transition-colors">The Movie Database</a></p>
            </div>
        </div>
    </footer>
