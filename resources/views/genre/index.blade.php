...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <a href="{{ route('genre.show', $genre['id']) }}"
           class="bg-dark-100 hover:bg-dark-300 border border-white/10 hover:border-primary rounded-xl p-6 text-center transition-all group">
            ...
            <h3 class="font-semibold group-hover:text-primary transition-colors">{{ $genre['name'] }}</h3>
        </a>
        @empty
