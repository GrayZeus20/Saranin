...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-wrap gap-2 mb-6">
        ...
        <a href="{{ route('genre.show', $g['id']) }}"
           class="px-4 py-2 rounded-full text-sm border transition-all {{ $g['name'] == $genreName ? 'bg-primary border-primary text-white' : 'bg-dark-100 border-white/10 hover:border-primary text-gray-300' }}">
            {{ $g['name'] }}
        </a>
        @endforeach
    </div>
