    ...
    <form action="{{ url(route('search', [], false)) }}" method="GET" class="mb-8">
        <div class="relative max-w-xl">
            ...
            <input type="text" name="q" value="{{ $query }}"
                   class="w-full bg-white/5 text-white placeholder-slate-400 rounded-2xl pl-11 pr-24 py-3.5 focus:outline-none focus:ring-1 focus:ring-accent/40 focus:bg-white/10 text-sm border border-white/5 transition-all"
