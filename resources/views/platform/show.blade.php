...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <p class="text-slate-500 text-sm mt-1">Movies available on this platform</p>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-5">
        ...
        @empty
            <div class="col-span-full text-center py-20">
                <p class="text-slate-500 text-lg mb-1">No movies available</p>
                <p class="text-slate-600 text-sm">Check back later for new releases</p>
            </div>
        @endforelse
    </div>
