            ...
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-3 mb-8">
                    <button onclick="watchlistAction(this, {{ $movie['id'] }}, '{{ addslashes($movie['title']) }}', '{{ app(App\Services\TmdbService::class)->imageUrl($movie['poster_path'] ?? '') }}')" 
                            class="bg-green-500 hover:bg-green-600 text-white px-6 py-2.5 rounded-lg font-semibold transition-all flex items-center gap-2">
                ...
                <div class="mb-6">
                    ...
                    <div class="scroll-container pb-2">
                        ...
                        <a href="{{ route('person.show', $cast['id']) }}" class="group">
                            ...
                            <p class="text-sm font-semibold truncate group-hover:text-green-500">{{ $cast['name'] }}</p>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="{{ route('person.show', $crew['id']) }}" class="text-sm hover:text-green-500">
...
<script>
    ...
    if (isInWatchlist({{ $movie['id'] }})) {
        ...
        if (btn) {
            ...
            btn.closest('button').classList.remove('bg-green-500', 'hover:bg-green-600');
        }
    }
